...
def load_flight_data(drop_last, path_airports_data, path_flights_data, path_positions_data):
    """
    ...
    positions_df = read_positions_data(path=path_positions_data, drop_last=drop_last)
